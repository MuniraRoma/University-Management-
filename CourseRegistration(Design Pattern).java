...
class RegistrationFileManager {
    ...
    private static RegistrationFileManager instance;

    private RegistrationFileManager(){}

    public static RegistrationFileManager getInstance(){
        if(instance == null){
            instance = new RegistrationFileManager();
        }
        return instance;
    }
...
class RegistrationDisplay {
    ...
    private static RegistrationDisplay instance;

    private RegistrationDisplay(){}

    public static RegistrationDisplay getInstance(){
        if(instance == null){
            instance = new RegistrationDisplay();
        }
        return instance;
    }
...
public class CourseRegistration {
    ...
    public static void manage(String regNumber){
        ...
        RegistrationFileManager fileManager = RegistrationFileManager.getInstance();
        RegistrationDisplay display = RegistrationDisplay.getInstance();
